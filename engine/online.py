...
class CausalReasoningEngine:
    ...
    """
    def __init__(self, json_file_path: str, model_id: str = "qwen-plus", api_type: str = "qwen", embedding_model: str = 'all-MiniLM-L6-v2'):
    ...
    def _direct_path_query(self, original_prompt_data: dict, causal_paths: list, query_type: str):
        ...
        **Your Instructions:**
        ...
        1.  **Validate and Search:** Critically evaluate the proposed pathway. Search Google Scholar for the top 10 most relevant papers. For each paper, provide the title and a summary of the abstract.
        ...
        **JSON Output Format:**
        ...
        print("Conducting comprehensive literature search and analysis on Google Scholar...")
